...
public class EquipmentCategoryService {
    ...
    public List<EquipmentCategory> getEquipmentCategories() {
        ...
        return models
            .stream()
            .map(model -> new EquipmentCategory(model.getId(), model.getName(), model.getDescription()))
    ...
    private EquipmentCategory getEquipmentCategoryByName(String name) {
        ...
        if (model != null) {
            return new EquipmentCategory(model.getId(), model.getName(), model.getDescription());
        }
        return null;
    }
}
